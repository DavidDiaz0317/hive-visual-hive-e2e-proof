...
- Evidence: project=hive-visual-hive-e2e-proof, packageManager=npm, frameworks=react, vite, scripts=build, dev, preview, test, test:e2e, test:e2e:update, test:python, routes=2, playwright=present
